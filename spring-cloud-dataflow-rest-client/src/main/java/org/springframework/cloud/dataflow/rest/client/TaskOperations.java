...
public interface TaskOperations {
   ...
   *
   * @param ids comma delimited set of
   *        {@link org.springframework.cloud.task.repository.TaskExecution} ids to stop.
   */
  ...
  /**
   * Return the task execution log. The platform from which to retrieve the log will be set to
   * {@code default}.
   *
