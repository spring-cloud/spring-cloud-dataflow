...
//		AppRegistry appRegistry = localDataflowResource.getWebApplicationContext().getBean(AppRegistry.class);
//		DataFlowUriRegistryPopulator dataFlowUriRegistryPopulator = localDataflowResource.getWebApplicationContext().getBean(DataFlowUriRegistryPopulator.class);
//		for (AppRegistration appRegistration: appRegistry.findAll()) {
//			appRegistry.delete(appRegistration.getName(), appRegistration.getType());
//		}
//		dataFlowUriRegistryPopulator.afterPropertiesSet();
	}
