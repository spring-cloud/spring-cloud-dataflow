...
NOTE: When using Cloud Foundry the cron expression will be: `*/1 * ? * *`.
...
```
dataflow:>task schedule destroy --name mytaskschedule-scdf-mytask
Deleted task schedule 'mytaskschedule-scdf-mytask'
```

In the example above we deleted the schedule `mytaskschedule-scdf-mytask`.  Notice that the name `mytaskschedule` given to the schedule has the suffix `-scdf-mytask`, this suffix is applied when the schedule is created.
...
╠══════════════════════════╪════════════════════╪════════════════════════════════════════════════════╣
║mytaskschedule-scdf-mytask│mytask              │spring.cloud.scheduler.cron.expression = */1 * * * *║
╚══════════════════════════╧════════════════════╧════════════════════════════════════════════════════╝
----
