...
* Maven based Task Applications: https://bit.ly/task-applications-maven
* Docker based Task Applications: https://bit.ly/task-applications-docker

For example, if you would like to register all out-of-the-box task applications in bulk, you can with
the following command.

```
dataflow:>app import --uri https://bit.ly/task-applications-maven
```
