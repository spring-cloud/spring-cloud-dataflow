...
To schedule a task from the UI click the Tasks tab at the top of the screen, this will take you to the Task Definitions screen.   From the Task Definition that you wish to schedule click the drop down icon and then select the `Schedule Task` option.
...
[[spring-cloud-data-flow-schedule-list]]
==== Listing Schedules
To view your tasks click the Tasks tab and then click the Schedules tab on the Tasks page.
