...
`task.timestamp=maven://org.springframework.cloud.task.app:timestamp-task:1.2.1.BUILD-SNAPSHOT`

`processor.transform=maven://org.springframework.cloud.stream.app:transform-processor-rabbit:1.2.1.BUILD-SNAPSHOT`
