...
For each metric there are 5 attributes that are available for each metric:
...
* Min - Shows the minimum value for this metric across all the step executions.
* Max - Shows the maximum value for this metric across all the step executions.
* Mean - Shows the mean value for this metric across all the step executions.
* Max - Shows the standard deviation for this metric across all the step executions.

NOTE: Counts (commit count for example) for a specific step execution, can be obtained by retrieving the job execution detail.

The Step Execution contains the following metrics:

* Commit Count - Attributes for the number of commits of all the executions for the given step.
* Duration - Attributes for the duration of all the executions for the given step.
* Duration Per Read - Attributes for the duration per read of all the executions for the given step.
* FilterCount - Attributes for the number of filters of all the executions for the given step.
* Process Skip Count - Attributes for the process skips of all the executions for the given step.
* Read Count - Attributes for the number of reads of all the executions for the given step.
* Read Skip Count - Attributes for the number of read skips of all the executions for the given step.
* Rollback Count - Attributes for the number of rollbacks of all the executions for the given step.
* Write Count - Attributes for the number of writes of all the executions for the given step.
* Write Skip Count - Attributes for the number of skips of all the executions for the given step.
