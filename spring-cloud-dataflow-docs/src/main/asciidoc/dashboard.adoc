...
Once the stream applications are deployed, their logs can be accessed from the Stream `summary` page as below:
...
The Streams section of the Dashboard includes an utils page, makes available the import and export streams.

The following image shows the streams export page:

. Stream Utils Export page
image::{dataflow-asciidoc}/images/dataflow-streams-utils-export.png[Export streams, scaledwidth="100%"]

On the streams import page, you have to provide a valid JSON file (generate an export file to see the structure).

. Stream Utils Import page
image::{dataflow-asciidoc}/images/dataflow-streams-utils-import.png[Import streams, scaledwidth="100%"]

After running the import, the result will be displayed, showing success and/or error creations.

. Stream Utils Import result page
image::{dataflow-asciidoc}/images/dataflow-streams-utils-import-result.png[Import result streams, scaledwidth="100%"]
...
The Tasks section of the Dashboard includes an utils page, makes available the import and export tasks.

The following image shows the tasks export page:

. Tasks Utils Export page
image::{dataflow-asciidoc}/images/dataflow-tasks-utils-export.png[Export tasks, scaledwidth="100%"]

On the tasks import page, you have to provide a valid JSON file (generate an export file to see the structure).

. Tasks Utils Import page
image::{dataflow-asciidoc}/images/dataflow-tasks-utils-import.png[Import tasks, scaledwidth="100%"]

After running the import, the result will be displayed, showing success and/or error creations.

. Tasks Utils Import result page
image::{dataflow-asciidoc}/images/dataflow-tasks-utils-import-result.png[Import result tasks, scaledwidth="100%"]
...
NOTE: Child Spring Cloud Task applications launched via Spring Batch applications that utilize remote partitioning will not be stopped.
