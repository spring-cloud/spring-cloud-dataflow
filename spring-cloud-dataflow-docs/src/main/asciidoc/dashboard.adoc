...
Schedules can be created from Task Definitions. Please see the https://dataflow.spring.io/documentation/{microsite-version}/feature-guides/batch/scheduling/[Scheduling Batch Jobs] section of the microsite for more information.
