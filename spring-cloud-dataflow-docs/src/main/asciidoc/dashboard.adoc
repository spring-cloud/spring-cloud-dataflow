...
The following image shows the list of task applications:
...
You can also specify various properties that are used during the deployment of the application.
...
The *Tasks* tab of the Dashboard includes a new *Utils* page that provides the option to import and export tasks.
...
For each task execution on the *Executions* tab, you can retrieve detailed information about a specific execution by clicking the information icon located to the right of the task execution.
...
The *Jobs* tab of the Dashboard lets you inspect batch jobs.
...
On the top of the page, you can see a progress indicator that shows the respective step, with the option to refresh the indicator.
