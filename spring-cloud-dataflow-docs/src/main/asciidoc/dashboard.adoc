...
_Apps_ encapsulate a unit of work into a reusable component. Within the Dataflow
runtime environment Apps allow users to create definitions for _Streams_ as
