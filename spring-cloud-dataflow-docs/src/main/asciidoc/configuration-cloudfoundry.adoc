...
This section discusses how to configure Spring Cloud Data Flow to connect to the https://www.cloudfoundry.org/the-foundry/scheduler/[PCF-Scheduler] as its agent to run tasks.
...
To create a PCF-Scheduler in your space (assuming it is in your Market Place), run the following from the CF CLI: `cf create-service scheduler-for-pcf standard <name of service>`.
