...
You also need to have link:http://redis.io/[Redis] and link:http://kafka.apache.org/[Apache Kafka] installed and running if you plan on running the Local server, or to run the included tests.
