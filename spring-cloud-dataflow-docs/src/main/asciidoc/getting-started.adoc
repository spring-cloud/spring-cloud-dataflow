...
For the deployed streams and tasks to communicate, either link:https://www.rabbitmq.com[RabbitMQ] or link:https://kafka.apache.org[Kafka] needs to be installed.
...
[source,bash,subs=attributes]
----
$ dataflow:>app import --uri https://bit.ly/Bacon-RELEASE-stream-applications-kafka-10-maven
----
+
