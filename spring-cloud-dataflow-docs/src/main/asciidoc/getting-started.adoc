...
----
+
And finally, modify the `app-import` service definition `command` attribute to replace `https://bit.ly/Celsius-SR2-stream-applications-kafka-10-maven` with `https://bit.ly/Celsius-SR2-stream-applications-rabbit-maven`.
