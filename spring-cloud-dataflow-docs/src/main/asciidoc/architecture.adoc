...
* A stream DSL that describes the logical flow of data through multiple long lived applications.
* A composed task DSL that describes the logical flow of data through multiple short lived applications.
