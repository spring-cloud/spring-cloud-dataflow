...
- Remove relevant task data as well as possibly associated Batch job data from the persistence store
...
include::{snippets}/task-executions-documentation/remove-task-execution/request-parameters.adoc[]
