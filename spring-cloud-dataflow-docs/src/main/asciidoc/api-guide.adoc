...
include::{snippets}/task-executions-documentation/remove-task-execution-detail/path-parameters.adoc[]
...
include::{snippets}/task-executions-documentation/lremove-task-execution/http-response.adoc[]
