...
For both the _Shell_ and the _Dashboard_, the `/security/info` REST Endpoint will be
used. That particular REST endpoint contains a property `roles` detailing the assigned
authorizations.
