...
When using traditional authentication with the Dataflow Shell, you typically provide
...
Alternatively, you can _target_ a Dataflow server also from within the Shell:
...
.Target and Authenticate with the Dataflow Server from within the Shell
image::{dataflow-asciidoc}/images/dataflow-security-shell-target.png[Target and Authenticate with the Dataflow Server from within the Shell, scaledwidth="100%"]
