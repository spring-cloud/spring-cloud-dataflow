...
To customize the "`out of the box`" Stream applications, use the https://start-scs.cfapps.io/[Spring Cloud Stream Initializr] to generate a project and then modify the pom.
