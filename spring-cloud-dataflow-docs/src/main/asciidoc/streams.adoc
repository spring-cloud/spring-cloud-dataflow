...
|Maven
|https://bit.ly/Clark-SR1-task-applications-maven
|https://bit.ly/Clark-BUILD-SNAPSHOT-task-applications-maven

|Docker
|https://bit.ly/Clark-SR1-task-applications-docker
...
[source,bash,subs=attributes]
----
$ dataflow:>app import --uri https://bit.ly/Darwin-SR3-stream-applications-kafka-maven
----
...
----
[[spring-cloud-dataflow-stream-lifecycle-skipper-force-update]]
