...
|Maven
|https://bit.ly/Clark-SR3-task-applications-maven
|https://bit.ly/Clark-BUILD-SNAPSHOT-task-applications-maven

|Docker
|https://bit.ly/Clark-SR3-task-applications-docker
...
----
$ dataflow:>app import --uri https://bit.ly/Darwin-SR1-stream-applications-kafka-maven
----
