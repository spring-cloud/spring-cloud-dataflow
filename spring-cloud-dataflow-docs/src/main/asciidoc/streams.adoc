...
If you desire to deploy your streams using Skipper, you need to pass certain properties to the server. With the new `SkipperDeploymentPropertiesBuilder` we made it simpler for you to enable it.
