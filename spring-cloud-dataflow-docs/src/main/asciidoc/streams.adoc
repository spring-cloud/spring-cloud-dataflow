...
== Stream applications with multiple binder configurations
 ...
 In some cases, a stream can have its applications bound to multiple spring cloud stream binders whey they are required to connect to different messaging
