...
In Spring Cloud Data Flow, a basic stream defines the ingestion of event data from a _source_ to a _sink_ that passes through any number of _processors_. Streams are composed of https://cloud.spring.io/spring-cloud-stream/[Spring Cloud Stream] applications and the deployment of stream definitions is done via the Data Flow Server (REST API). The xref:getting-started#getting-started[Getting Started] section shows you how to start the server and how to start and use the Spring Cloud Data Flow shell.
...
|RabbitMQ + Maven |link:https://bit.ly/Avogadro-SR1-stream-applications-rabbit-maven[https://bit.ly/Avogadro-SR1-stream-applications-rabbit-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-rabbit-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-rabbit-maven]
|RabbitMQ + Docker|link:https://bit.ly/Avogadro-SR1-stream-applications-rabbit-docker[https://bit.ly/Avogadro-SR1-stream-applications-rabbit-docker] | N/A ]
|Kafka 0.9 + Maven 	  |link:https://bit.ly/Avogadro-SR1-stream-applications-kafka-09-maven[https://bit.ly/Avogadro-SR1-stream-applications-kafka-09-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-09-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-09-maven]
|Kafka 0.9 + Docker   |link:https://bit.ly/Avogadro-SR1-stream-applications-kafka-09-docker[https://bit.ly/Avogadro-SR1-stream-applications-kafka-09-docker] | N/A ]
|Kafka 0.10 + Maven 	  |link:https://bit.ly/Avogadro-SR1-stream-applications-kafka-10-maven[https://bit.ly/Avogadro-SR1-stream-applications-kafka-10-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-10-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-10-maven]
|Kafka 0.10 + Docker   |https://bit.ly/Avogadro-SR1-stream-applications-kafka-10-docker[https://bit.ly/Avogadro-SR1-stream-applications-kafka-10-docker] | N/A ]
|======================
...
|======================
|Artifact Type |Stable Release |SNAPSHOT Release
|Maven   |https://bit.ly/Addison-GA-task-applications-maven[https://bit.ly/Addison-GA-task-applications-maven] |link:https://bit.ly/Belmont-BUILD-SNAPSHOT-task-applications-maven[https://bit.ly/Belmont-BUILD-SNAPSHOT-task-applications-maven]
|Docker  |link:https://bit.ly/Addison-GA-task-applications-docker[https://bit.ly/Addison-GA-task-applications-docker] | N/A ]
|======================

You can find more information about the available task starters look the https://cloud.spring.io/spring-cloud-task-app-starters/[Task App Starters Project Page] and
