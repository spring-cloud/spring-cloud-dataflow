...
|RabbitMQ + Maven |link:https://bit.ly/Avogadro-GA-stream-applications-rabbit-maven[https://bit.ly/Avogadro-GA-stream-applications-rabbit-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-rabbit-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-rabbit-maven]
|RabbitMQ + Docker|link:https://bit.ly/Avogadro-GA-stream-applications-rabbit-docker[https://bit.ly/Avogadro-GA-stream-applications-rabbit-docker] | N/A ]
|Kafka 0.9 + Maven 	  |link:https://bit.ly/Avogadro-GA-stream-applications-kafka-09-maven[https://bit.ly/Avogadro-GA-stream-applications-kafka-09-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-09-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-09-maven]
|Kafka 0.9 + Docker   |link:https://bit.ly/Avogadro-GA-stream-applications-kafka-09-docker[https://bit.ly/Avogadro-GA-stream-applications-kafka-09-docker] | N/A ]
|Kafka 0.10 + Maven 	  |link:https://bit.ly/Avogadro-GA-stream-applications-kafka-10-maven[https://bit.ly/Avogadro-GA-stream-applications-kafka-10-maven] |link:https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-10-maven[https://bit.ly/Bacon-BUILD-SNAPSHOT-stream-applications-kafka-10-maven]
|Kafka 0.10 + Docker   |https://bit.ly/Avogadro-GA-stream-applications-kafka-10-docker[https://bit.ly/Avogadro-GA-stream-applications-kafka-10-docker] | N/A ]
|======================
