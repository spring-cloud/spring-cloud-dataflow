...
. <<spring-cloud-dataflow-streams-skipper-upgrading,Upgrade>> or <<spring-cloud-dataflow-streams-skipper-rollback,Rollback>> applications in the Stream.
...
|RabbitMQ + Maven
|http://bit.ly/Darwin-SR2-stream-applications-rabbit-maven
