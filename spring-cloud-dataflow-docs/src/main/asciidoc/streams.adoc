...
* Configure the Data Flow Server to delegate the deployment to a new server in the Spring Cloud ecosystem named https://cloud.spring.io/spring-cloud-skipper/[Skipper].
...
See https://cloud.spring.io/spring-cloud-dataflow/#platform-implementations[the Spring Cloud Data Flow project page] for a list of Data Flow server implementations.
...
|RabbitMQ + Maven
|https://bit.ly/Celsius-SR3-stream-applications-rabbit-maven
|https://bit.ly/Celsius-BUILD-SNAPSHOT-stream-applications-rabbit-maven

|RabbitMQ + Docker
|https://bit.ly/Celsius-SR3-stream-applications-rabbit-docker
|https://bit.ly/Celsius-BUILD-SNAPSHOT-stream-applications-rabbit-docker

|Kafka 0.10 + Maven
|https://bit.ly/Celsius-SR3-stream-applications-kafka-10-maven
|https://bit.ly/Celsius-BUILD-SNAPSHOT-stream-applications-kafka-10-maven

|Kafka 0.10 + Docker
|https://bit.ly/Celsius-SR3-stream-applications-kafka-10-docker
|https://bit.ly/Celsius-BUILD-SNAPSHOT-stream-applications-kafka-10-docker
|======================
...
|RabbitMQ + Maven
|https://bit.ly/Darwin-GA-stream-applications-rabbit-maven
|https://bit.ly/Darwin-BUILD-SNAPSHOT-stream-applications-rabbit-maven

|RabbitMQ + Docker
|https://bit.ly/Darwin-GA-stream-applications-rabbit-docker
|https://bit.ly/Darwin-BUILD-SNAPSHOT-stream-applications-rabbit-docker

|Kafka 0.11 and above + Maven
|https://bit.ly/Darwin-GA-stream-applications-kafka-10-maven
|https://bit.ly/Darwin-BUILD-SNAPSHOT-stream-applications-kafka-10-maven

|Kafka 0.11 and above + Docker
|https://bit.ly/Darwin-GA-stream-applications-kafka-10-docker
|https://bit.ly/Darwin-BUILD-SNAPSHOT-stream-applications-kafka-10-docker
|======================
...
|Maven
|https://bit.ly/Clark-GA-task-applications-maven
|https://bit.ly/Clark-BUILD-SNAPSHOT-task-applications-maven

|Docker
|https://bit.ly/Clark-GA-task-applications-docker
|https://bit.ly/Clark-BUILD-SNAPSHOT-task-applications-docker
|======================
...
----
$ dataflow:>app import --uri https://bit.ly/Darwin-GA-stream-applications-kafka-10-maven
----
...
[source,bash,subs=attributes]
----
$ dataflow:>app import --uri https://bit.ly/Darwin-GA-stream-applications-rabbit-maven
----
...
dataFlowOperations.appRegistryOperations().importFromResource(
                     "https://bit.ly/Darwin-GA-stream-applications-rabbit-maven", true);
