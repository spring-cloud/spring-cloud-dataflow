...
|Maven
|http://bit.ly/Clark-SR3-task-applications-maven
|http://bit.ly/Clark-BUILD-SNAPSHOT-task-applications-maven

|Docker
|http://bit.ly/Clark-SR3-task-applications-docker
...
[source,bash,subs=attributes]
----
$ dataflow:>app import --uri http://bit.ly/Darwin-SR1-stream-applications-kafka-maven
----
