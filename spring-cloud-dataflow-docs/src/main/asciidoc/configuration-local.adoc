...
[source,bash]
----
java -jar spring-cloud-dataflow/spring-cloud-dataflow-server/target/spring-cloud-dataflow-server-2.3.1.BUILD-SNAPSHOT.jar --spring.config.additional-location=scdf.yml
----
