...
If you enable sensitive endpoints, you should also <<configuration-security-oauth2,secure the Data Flow server's endpoints>> so that information is not inadvertently exposed to unauthenticated users.
