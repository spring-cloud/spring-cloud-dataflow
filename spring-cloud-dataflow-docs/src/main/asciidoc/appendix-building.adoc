...
https://www.eclipse.org[Eclipse] when working with the code. We use the
https://www.eclipse.org/m2e/[m2eclipe] eclipse plugin for maven support. Other IDEs and tools
should also work without issue.

==== Importing into eclipse with m2eclipse
We recommend the https://www.eclipse.org/m2e/[m2eclipe] eclipse plugin when working with
