...
public class AggregateTaskExecution {
	...
	public TaskExecution toTaskExecution() {
		return new TaskExecution(executionId,
				exitCode,
				taskName,
				(startTime == null) ? null : LocalDateTime.ofInstant(startTime.toInstant(), ZoneId.systemDefault()),
				(endTime == null) ? null : LocalDateTime.ofInstant(endTime.toInstant(), ZoneId.systemDefault()),
				exitMessage,
				arguments,
				errorMessage,
				externalExecutionId,
