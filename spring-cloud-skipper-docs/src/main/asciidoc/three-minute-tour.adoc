...
Picking up from where the <<three-second-tour>> left off, this section walk through additional commands and features of Skipper.  Each section walk through the same set of operations, but for a different plaform.
...
║               │       │             │        │   Name   │ Version │  Name   │                                                                       ║
╠═══════════════╪═══════╪═════════════╪════════╪══════════╪═════════╪═════════╪═══════════════════════════════════════════════════════════════════════╣
║helloworldlocal│1      │Thu Oct 26   │DEPLOYED│helloworld│1.0.0    │default  │helloworldlocal.helloworld-v1[helloworldlocal.helloworld-v1-0=deployed]║
║               │       │16:40:12 EDT │        │          │         │         │                                                                       ║
║               │       │2017         │        │          │         │         │                                                                       ║
╚═══════════════╧═══════╧═════════════╧════════╧══════════╧═════════╧═════════╧═══════════════════════════════════════════════════════════════════════╝
----
...
╠═══════╪════════════════════════════╪════════╪════════════╪═══════════════╪════════════════╣
║2      │Thu Oct 26 16:40:31 EDT 2017│DEPLOYED│helloworld  │1.0.1          │Upgrade complete║
║1      │Thu Oct 26 16:40:12 EDT 2017│DELETED │helloworld  │1.0.0          │Delete complete ║
╚═══════╧════════════════════════════╧════════╧════════════╧═══════════════╧════════════════╝
----

Do see what changed, you can look at the Skipper manifest for each release using the `manifest get` command.
...
║Version│        Last updated        │ Status │Package Name│Package Version│  Description   ║
╠═══════╪════════════════════════════╪════════╪════════════╪═══════════════╪════════════════╣
║3      │Thu Oct 26 16:49:18 EDT 2017│DEPLOYED│helloworld  │1.0.0          │Upgrade complete║
║2      │Thu Oct 26 16:40:31 EDT 2017│DELETED │helloworld  │1.0.1          │Delete complete ║
║1      │Thu Oct 26 16:40:12 EDT 2017│DELETED │helloworld  │1.0.0          │Delete complete ║
╚═══════╧════════════════════════════╧════════╧════════════╧═══════════════╧════════════════╝
----
...
As it takes a bit of time for the app to spin up, you can monitor the process using the `status command`.
[source,bash,options="nowrap"]
----
...
helloworldk8s has been upgraded.
Last Deployed: Wed Oct 25 13:29:01 EDT 2017
----
