...
╔═══════════════╤══════════════════════════════════════════════════════════════════════════════════════╗
║Last Deployed  │Wed Oct 25 12:31:49 EDT 2017                                                          ║
║Status         │DEPLOYED                                                                              ║
║Platform Status│The applications are being deployed.                                                  ║
║               │helloworldk8s-helloworld-docker-v1[helloworldk8s-helloworld-docker-v1-8wghk=deploying]║
╚═══════════════╧══════════════════════════════════════════════════════════════════════════════════════╝
----
...
helloworldk8s-helloworld-docker-v1-8wghk   1/1       Running   0          3m

$ kubectl get service
NAME                                 CLUSTER-IP   EXTERNAL-IP   PORT(S)          AGE
helloworldk8s-helloworld-docker-v1   10.0.0.68    <nodes>       8080:32123/TCP   3m
...
$ kubectl get all
NAME                                          READY     STATUS    RESTARTS   AGE
po/helloworldk8s-helloworld-docker-v1-4kqrf   1/1       Running   0          3m
po/helloworldk8s-helloworld-docker-v2-1rv71   1/1       Running   0          54s

NAME                                    DESIRED   CURRENT   READY     AGE
rc/helloworldk8s-helloworld-docker-v1   1         1         1         3m
rc/helloworldk8s-helloworld-docker-v2   1         1         1         54s

NAME                                     CLUSTER-IP   EXTERNAL-IP   PORT(S)          AGE
svc/helloworldk8s-helloworld-docker-v1   10.0.0.247   <nodes>       8080:32123/TCP   3m
svc/helloworldk8s-helloworld-docker-v2   10.0.0.180   <none>        8080/TCP         55s
