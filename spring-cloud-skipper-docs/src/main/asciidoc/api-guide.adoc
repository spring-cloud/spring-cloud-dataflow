...
A `GET` request will return the list of available package metadata with the summary information of each package
...
A `GET` request will return a list for all Spring Cloud Skipper package metadata by the given package name.
...
A `GET` request will return a list for all Spring Cloud Skipper package metadata by the given package name ignoring case.
