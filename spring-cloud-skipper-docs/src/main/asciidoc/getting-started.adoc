...
An embedded H2 database is used if you do not provide a Data Source configuration via Spring Boot configuration properties.
...
The default configuration of Skipper will deploy apps to the local machine.
...
Install the Maven based Hello World application using the `package install` command.
