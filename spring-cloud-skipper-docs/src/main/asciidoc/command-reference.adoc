...
* <<skipper-commands-repo-add>>
* <<skipper-commands-repo-delete>>
* <<skipper-commands-repo-list>>

[[skipper-commands-repo-add]]
=== Add
This command adds a repository.
...
SYNOPSYS::
	repo add [*--name*] string  [*--url*] string  [[*--source-url*] string]
...
OPTIONS::
	...
	--url  string:::
		the root URL that points to index.yaml file +
		*[Mandatory]* +
		*[may not be null]* +

	--source-url  string:::
		the source URL to the package +
		*[Optional, default = <none>]* +
====

[[skipper-commands-repo-delete]]
=== Delete
This command deletes a repository.
