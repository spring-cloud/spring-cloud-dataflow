...
scdf.tanzu.vmware.com.2.9.5-SNAPSHOT   scdf.tanzu.vmware.com   2.9.5-SNAPSHOT   2m23s
----
...
Install `2.9.5-SNAPSHOT` with `postgres` and `rabbit`:
...
scdf-demo   scdf.tanzu.vmware.com   2.9.5-SNAPSHOT    Reconciling   12s

kubectl get packageinstalls
NAME        PACKAGE NAME            PACKAGE VERSION   DESCRIPTION           AGE
scdf-demo   scdf.tanzu.vmware.com   2.9.5-SNAPSHOT    Reconcile succeeded   88s
----
