...
scdf.tanzu.vmware.com.2.11.2-SNAPSHOT  scdf.tanzu.vmware.com   2.11.2-SNAPSHOT   2m23s
----
...
Install `2.11.2-SNAPSHOT` with `postgres` and `rabbit`:
...
scdf-demo   scdf.tanzu.vmware.com   2.11.2-SNAPSHOT   Reconciling   12s

kubectl get packageinstalls
NAME        PACKAGE NAME            PACKAGE VERSION   DESCRIPTION           AGE
scdf-demo   scdf.tanzu.vmware.com   2.11.2-SNAPSHOT   Reconcile succeeded   88s
----
