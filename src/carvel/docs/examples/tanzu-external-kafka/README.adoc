...
[source, bash]
----
tanzu package repository add scdf-repo --url springcloud/scdf-repo:2.8.5-SNAPSHOT

tanzu package repository list
  NAME        REPOSITORY                            STATUS               DETAILS
  scdf-repo   springcloud/scdf-repo:2.8.5-SNAPSHOT  Reconcile succeeded
...
tanzu package available list scdf.tanzu.vmware.com
  ...
  scdf.tanzu.vmware.com  2.8.5-SNAPSHOT

tanzu package available get scdf.tanzu.vmware.com/2.8.5-SNAPSHOT --values-schema
