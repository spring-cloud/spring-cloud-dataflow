...
[source, bash]
----
tanzu package repository add scdf-repo --url springcloud/scdf-repo:2.11.0-SNAPSHOT

tanzu package repository list
  NAME        REPOSITORY                            STATUS               DETAILS
  scdf-repo   springcloud/scdf-repo:2.11.0-SNAPSHOT Reconcile succeeded
...
tanzu package available get scdf.tanzu.vmware.com/2.11.0-SNAPSHOT --values-schema
