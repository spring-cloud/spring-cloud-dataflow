...
[source, bash]
----
tanzu package repository add scdf-oss-repo --url springcloud/scdf-oss-repo:2.11.2-SNAPSHOT

tanzu package repository list
  NAME        REPOSITORY                            STATUS               DETAILS
  scdf-oss-repo   springcloud/scdf-oss-repo:2.11.2-SNAPSHOT Reconcile succeeded
...
tanzu package available list scdf.tanzu.vmware.com
  ...
  scdf.tanzu.vmware.com  2.11.2-SNAPSHOT

tanzu package available get scdf.tanzu.vmware.com/2.11.2-SNAPSHOT --values-schema
