...
[source, bash]
----
imgpkg pull -b springcloud/scdf-repo:2.10.1-SNAPSHOT -o scdf-repo-snapshot
imgpkg pull -b springcloud/scdf-package:2.10.1-SNAPSHOT -o scdf-package-snapshot
----
