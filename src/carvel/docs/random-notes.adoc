...
[source, bash]
----
imgpkg pull -b springcloud/scdf-repo:2.11.0-SNAPSHOT -o scdf-repo-snapshot
imgpkg pull -b springcloud/scdf-package:2.11.0-SNAPSHOT -o scdf-package-snapshot
----
