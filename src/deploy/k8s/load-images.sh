...
sh "$SCDIR/load-image.sh" "springcloudtask/timestamp-task" "2.0.2" true
sh "$SCDIR/load-image.sh" "springcloudtask/timestamp-task" "3.0.0" true
sh "$SCDIR/load-image.sh" "springcloudtask/timestamp-batch-task" "2.0.2" true
sh "$SCDIR/load-image.sh" "springcloudtask/timestamp-batch-task" "3.0.0" true
