...
public class TestProperties {
	...
	/**
	 * Data Flow Server connect URL.
	 */
	public static final String TEST_DOCKER_COMPOSE_DATAFLOW_SERVER_URL = PREFIX + "dataflow.server.url";

	/**
	 * Set then target platform name to be used for testing.
	 */
	public static final String TEST_DOCKER_COMPOSE_PLATFORM_NAME = PREFIX + "platform.name";
