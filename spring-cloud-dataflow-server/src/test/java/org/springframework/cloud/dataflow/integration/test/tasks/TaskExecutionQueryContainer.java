...
public class TaskExecutionQueryContainer {
	...
	@SpringBootTest(classes = DataFlowServerApplication.class, properties = {
			"spring.jpa.hibernate.ddl-auto=none", "spring.datasource.hikari.maximum-pool-size=5"
	})
	...
	static class MariaDB_10_6_TaskExecutionQueryIT extends AbstractLargeTaskExecutionDatabaseIT
			implements MariaDB_10_6_ContainerSupport {

	}

	static class MariaDB_11_TaskExecutionQueryIT extends AbstractLargeTaskExecutionDatabaseIT
			implements MariaDB_11_ContainerSupport {
	}

	static class MySql_5_7_TaskExecutionQueryIT extends AbstractLargeTaskExecutionDatabaseIT
	...
	static class SqlServer_2022_TaskExecutionQueryIT extends AbstractLargeTaskExecutionDatabaseIT
