...
./mvnw clean test-compile failsafe:integration-test -pl spring-cloud-dataflow-server -Pfailsafe
   ...
   -Dtest.docker.compose.stream.apps.uri=https://dataflow.spring.io/rabbitmq-maven-einstein
...
./mvnw clean test-compile failsafe:integration-test -pl spring-cloud-dataflow-server -Pfailsafe \
   ...
   -Dtest.docker.compose.stream.apps.uri=https://dataflow.spring.io/kafka-docker-einstein \
