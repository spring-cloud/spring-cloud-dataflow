 ...
 * {@link SimpleShellCommandLineOptions#parseCommandLine(String[])} method in that
 * additional passed in arguments are not interpreted to be commands to execute and then
 * quit. Only by passing in the options <code>--spring.shell.commandFile</code> can you
 * execute commands in the shell and then quit.
 *
 * @author Mark Pollack
 */
public class ShellCommandLineParser {
	...
	/**
	 * Parse {@link ShellProperties} and {@link ApplicationArguments} to create an instance of
	 * the
	 *
