...
public class LocalServerSecurityRootWithUsersFileTests {
	...
	public void testAccessRootUrlAndCheckAllLinksWithFullUser() throws Exception {
		localDataflowResource.getMockMvc()
				...
				.andExpect(jsonPath("$._links.*", hasSize(45)))
				...
				.andExpect(jsonPath("$._links.streams/validation.href", is("http://localhost/streams/validation/{name}")))
				.andExpect(jsonPath("$._links.runtime/apps.href", is("http://localhost/runtime/apps")))
				.andExpect(jsonPath("$._links.runtime/apps.href", is("http://localhost/runtime/apps/{appId}")))
				...
				.andExpect(jsonPath("$._links.tasks/validation.href", is("http://localhost/tasks/validation/{name}")))
				...
				.andExpect(jsonPath("$._links.jobs/thinexecutions.href", is("http://localhost/jobs/thinexecutions")))
