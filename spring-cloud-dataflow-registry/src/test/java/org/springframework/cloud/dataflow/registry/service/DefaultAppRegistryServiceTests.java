...
public class DefaultAppRegistryServiceTests {
	...
	public void testImportRealWorldJarsWithMetadata() {
		...
		assertThat(appRegistration, hasProperty("uri",
				is(URI.create("https://repo.maven.apache.org/maven2/org/springframework/cloud/stream/app/cassandra-sink-rabbit/2.1.0.RELEASE/cassandra-sink-rabbit-2.1.0.RELEASE.jar"))));
		assertThat(appRegistration, hasProperty("metadataUri",
				is(URI.create("https://repo.maven.apache.org/maven2/org/springframework/cloud/stream/app/cassandra-sink-rabbit/2.1.0.RELEASE/cassandra-sink-rabbit-2.1.0.RELEASE-metadata.jar"))));
