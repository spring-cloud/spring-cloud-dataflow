 ...
 * @author Mark Fisher
 */
public class ReceptorLrpModuleDeployer implements ModuleDeployer {

	private static final Logger logger = LoggerFactory.getLogger(ReceptorLrpModuleDeployer.class);
