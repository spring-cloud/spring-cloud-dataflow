...
//		}
	...
	public void verifyExists(String streamName, String definition, boolean deployed) {
		...
		Collection<String> statuses = deployed ? Arrays.asList(DeploymentStateResource.DEPLOYED.getKey(), DeploymentStateResource.DEPLOYING.getKey()) : Arrays.asList(DeploymentStateResource.UNDEPLOYED.getKey());
