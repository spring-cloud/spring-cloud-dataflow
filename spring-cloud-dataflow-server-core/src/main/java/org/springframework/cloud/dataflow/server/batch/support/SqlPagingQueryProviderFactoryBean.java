...
/**
 * Factory bean for {@link DataflowSqlPagingQueryProvider} interface. The database type
 ...
 */
public class SqlPagingQueryProviderFactoryBean implements FactoryBean<DataflowSqlPagingQueryProvider> {
	...
	/**
	 * Get a {@link DataflowSqlPagingQueryProvider} instance using the provided properties
	 * and appropriate for the given database type.
	 * 
	 * @see FactoryBean#getObject()
	 */
    @Override
	public DataflowSqlPagingQueryProvider getObject() throws Exception {

		DatabaseType type;
		try {
			type = databaseType != null ? DatabaseType.valueOf(databaseType.toUpperCase(Locale.ROOT)) : DatabaseType
	...
	/**
	 * Always returns {@link DataflowSqlPagingQueryProvider}.
	 * 
	 * @see FactoryBean#getObjectType()
	 */
    @Override
	public Class<DataflowSqlPagingQueryProvider> getObjectType() {
		return DataflowSqlPagingQueryProvider.class;
	}
