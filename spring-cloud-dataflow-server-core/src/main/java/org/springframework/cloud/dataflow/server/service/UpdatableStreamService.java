...
/**
 * Extends the core {@link StreamService} operations with support for update, rollback and deployment history
 *
 * @author Mark Pollack
 * @author Ilayaperumal Gopinathan
 * @author Christian Tzolov
 */
public interface UpdatableStreamService extends StreamService {
