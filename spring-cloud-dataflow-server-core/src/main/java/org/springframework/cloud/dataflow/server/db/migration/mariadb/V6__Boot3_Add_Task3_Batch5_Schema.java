...
public class V6__Boot3_Add_Task3_Batch5_Schema extends AbstractBoot3InitialSetupMigration {
	...
	private final static String CREATE_TASK_EXECUTION_TABLE =
	...
	private final static String CREATE_TASK_EXECUTION_PARAMS_TABLE =
	...
	private final static String CREATE_TASK_TASK_BATCH =
	...
	private final static String CREATE_TASK_LOCK_TABLE =
	...
	private final static String CREATE_TASK_SEQ =
	...
	private final static String CREATE_TASK_EXECUTION_METADATA_TABLE =
	...
	private final static String CREATE_TASK_EXECUTION_METADATA_SEQ =
	...
	private final static String CREATE_BATCH_JOB_INSTANCE_TABLE =
	...
	private final static String CREATE_BATCH_JOB_EXECUTION_TABLE =
	...
	private final static String CREATE_BATCH_JOB_EXECUTION_PARAMS_TABLE =
	...
	private final static String CREATE_BATCH_STEP_EXECUTION_TABLE =
	...
	private final static String CREATE_BATCH_STEP_EXECUTION_CONTEXT_TABLE =
	...
	private final static String CREATE_BATCH_JOB_EXECUTION_CONTEXT_TABLE =
	...
	private final static String CREATE_BATCH_STEP_EXECUTION_SEQ =
			"CREATE SEQUENCE BOOT3_BATCH_STEP_EXECUTION_SEQ START WITH 1 MINVALUE 1 MAXVALUE 9223372036854775806 INCREMENT BY 1 NOCACHE NOCYCLE ENGINE=InnoDB";

	private final static String CREATE_BATCH_JOB_EXECUTION_SEQ =
			"CREATE SEQUENCE BOOT3_BATCH_JOB_EXECUTION_SEQ START WITH 1 MINVALUE 1 MAXVALUE 9223372036854775806 INCREMENT BY 1 NOCACHE NOCYCLE ENGINE=InnoDB";

	private final static String CREATE_BATCH_JOB_SEQ =
			"CREATE SEQUENCE BOOT3_BATCH_JOB_SEQ START WITH 1 MINVALUE 1 MAXVALUE 9223372036854775806 INCREMENT BY 1 NOCACHE NOCYCLE ENGINE=InnoDB";
	...
	public List<SqlCommand> createTask3Tables() {
		return Arrays.asList(
				...
				SqlCommand.from(CREATE_TASK_SEQ),
	...
	public List<SqlCommand> createBatch5Tables() {
		return Arrays.asList(
				...
				SqlCommand.from(CREATE_BATCH_STEP_EXECUTION_SEQ),
				SqlCommand.from(CREATE_BATCH_JOB_EXECUTION_SEQ),
				SqlCommand.from(CREATE_BATCH_JOB_SEQ)
		);
	}
