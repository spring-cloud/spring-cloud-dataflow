...
public class DefaultStreamDefinitionAssemblerProvider implements StreamDefinitionAssemblerProvider<StreamDefinitionResource> {
	...
	public DefaultStreamDefinitionAssemblerProvider(StreamDefinitionService streamDefinitionService,
	...
	@Override
	public DefaultStreamDefinitionAssembler getStreamDefinitionAssembler(
			List<StreamDefinition> streamDefinitions) {
		return new DefaultStreamDefinitionAssembler(streamDefinitionService, streamService, streamDefinitions,
