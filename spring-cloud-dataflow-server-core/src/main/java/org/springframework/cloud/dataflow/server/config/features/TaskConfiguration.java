...
public class TaskConfiguration {
	...
	public TaskService taskService(TaskDefinitionRepository repository, TaskExplorer taskExplorer,
			...
			TaskValidationService taskValidationService, TaskExecutionRepositoryService taskExecutionRepositoryService) {
		return new DefaultTaskService(dataSourceProperties, repository, taskExplorer, taskExecutionRepository, registry,
				...
				dataflowServerUri, commonApplicationProperties, taskValidationService, taskExecutionRepositoryService);
	}
