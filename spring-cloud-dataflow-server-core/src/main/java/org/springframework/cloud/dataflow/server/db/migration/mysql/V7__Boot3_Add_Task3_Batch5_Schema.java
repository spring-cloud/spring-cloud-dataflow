...
public class V7__Boot3_Add_Task3_Batch5_Schema extends AbstractBoot3InitialSetupMigration {
	...
	private final static String CREATE_TASK_EXECUTION_METADATA_SEQ_TABLE =
	...
	private final static String INIT_TASK_EXECUTION_METADATA_SEQ =
	...
	private final static String INIT_BATCH_STEP_EXECUTION_SEQ =
	...
	private final static String INIT_BATCH_JOB_EXECUTION_SEQ =
	...
	private final static String INIT_BATCH_JOB_SEQ =
	...
	public List<SqlCommand> createTask3Tables() {
		return Arrays.asList(
				...
				SqlCommand.from(CREATE_TASK_EXECUTION_METADATA_SEQ_TABLE),
				SqlCommand.from(INIT_TASK_EXECUTION_METADATA_SEQ));
	}
