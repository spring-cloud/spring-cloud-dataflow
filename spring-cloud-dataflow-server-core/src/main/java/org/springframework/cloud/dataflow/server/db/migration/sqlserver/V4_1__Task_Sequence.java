...
public class V4_1__Task_Sequence extends AbstractMigration {
	...
	// StatementCallback; uncategorized SQLException for SQL create sequence TASK_SEQ start with 1 increment by 1];
	// SQL state [S0001]; error code [2714]; There is already an object named 'TASK_SEQ' in the database.;
	// nested exception is com.microsoft.sqlserver.jdbc.SQLServerException:
	// There is already an object named 'TASK_SEQ' in the database.
	...
	public void migrate(Context context) throws Exception {
		...
		try {
			...
			logger.debug("Unable to query TASK_SEQ table, looks like we have a proper sequence", e);
		}
