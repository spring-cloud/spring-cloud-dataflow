...
/**
 * Default implementation of the {@link DefaultTaskDefinitionRetriever} interface. Provide
 * service methods for {@link DefaultTaskExecutionService} about task definitions and
 ...
 */
public class DefaultTaskDefinitionRetriever implements TaskDefinitionRetriever {
	...
	/**
	 * Initializes the {@link DefaultTaskDefinitionRetriever}.
	 *
	 ...
	 */
	public DefaultTaskDefinitionRetriever(DataSourceProperties dataSourceProperties, AppRegistryService registry,
	...
	@Override
	public TaskExecutionInformation retrieveTaskDefinitionInformation(String taskName,
		...
		retData.setAppResource(registry.getAppResource(appRegistration));
		retData.setMetadataResource(registry.getAppMetadataResource(appRegistration));
		retData.setTaskExecution(taskExecutionRepository.createTaskExecution(taskName));
		return retData;
	}

	@Override
	public void updateExternalExecutionId(long executionId, String taskLaunchId) {
		this.taskExecutionRepository.updateExternalExecutionId(executionId, taskLaunchId);
	}
