    ...
    public RootResource info() {
        ...
        if (featuresProperties.isStreamsEnabled()) {
            ...
            root.add(unescapeTemplateVariables(
                    entityLinks.linkToItemResource(StreamDefinitionResource.class, "{name}")
                            .withRel("streams/definitions/definition"))
            );
            root.add(unescapeTemplateVariables(
                    entityLinks.linkToItemResource(StreamAppStatusResource.class, "{name}")
                            .withRel("streams/validation"))
            );

            root.add(linkTo(
					methodOn(RuntimeStreamsController.class).status(null, null, null)
            ).withRel("runtime/streams"));
            root.add(linkTo(
					methodOn(RuntimeStreamsController.class).streamStatus(null, null, null)
			).withRel("runtime/streams/{streamNames}"));

            root.add(linkTo(
					methodOn(RuntimeAppsController.class).list(null, null)
			).withRel("runtime/apps"));
            root.add(linkTo(
					methodOn(RuntimeAppsController.class).display(null)
			).withRel("runtime/apps/{appId}"));

            root.add(linkTo(
					methodOn(RuntimeAppInstanceController.class).list(null, null, null)
			).withRel("runtime/apps/{appId}/instances"));
            root.add(linkTo(
					methodOn(RuntimeAppInstanceController.class).display(null, null)
			).withRel("runtime/apps/{appId}/instances/{instanceId}"));

            root.add(linkTo(
					methodOn(RuntimeAppInstanceController.class).getFromActuator(null, null, null)
			).withRel("runtime/apps/{appId}/instances/{instanceId}/actuator"));
            root.add(linkTo(
					methodOn(RuntimeAppInstanceController.class).postToActuator(null, null, null)
			).withRel("runtime/apps/{appId}/instances/{instanceId}/actuator"));

            root.add(linkTo(
					methodOn(RuntimeAppInstanceController.class).postToUrl(null, null, null, null)
			).withRel("runtime/apps/{appId}/instances/{instanceId}/post"));

            root.add(linkTo(StreamDeploymentController.class).withRel("streams/deployments"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).info(null, false)
			).withRel("streams/deployments/{name}{?reuse-deployment-properties}"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).deploy(null, null)
			).withRel("streams/deployments/{name}"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).history(null)
			).withRel("streams/deployments/history/{name}"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).manifest(null, null)
			).withRel("streams/deployments/manifest/{name}/{version}"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).platformList()
			).withRel("streams/deployments/platform/list"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).rollback(null, null)
			).withRel("streams/deployments/rollback/{name}/{version}"));
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).update(null, null)
			).withRel("streams/deployments/update/{name}"));
            root.add(
				unescapeTemplateVariables(
					entityLinks.linkToItemResource(StreamDeploymentResource.class, "{name}")
						.withRel("streams/deployments/deployment")
				)
			);
            root.add(linkTo(
					methodOn(StreamDeploymentController.class).scaleApplicationInstances(null, null, null, null)
			).withRel("streams/deployments/scale/{streamName}/{appName}/instances/{count}"));
            root.add(linkTo(StreamLogsController.class).withRel("streams/logs"));
            root.add(linkTo(
					methodOn(StreamLogsController.class).getLog(null)
			).withRel("streams/logs/{streamName}"));
            root.add(linkTo(
					methodOn(StreamLogsController.class).getLog(null, null)
			).withRel("streams/logs/{streamName}/{appName}"));
        }
        if (featuresProperties.isTasksEnabled()) {
            ...
            root.add(linkTo(
					methodOn(TaskExecutionController.class).getCurrentTaskExecutionsInfo()
			).withRel("tasks/executions/current"));
            root.add(
				unescapeTemplateVariables(entityLinks.linkToItemResource(TaskExecutionResource.class, "{id}")
                    .withRel("tasks/executions/execution"))
			);
            root.add(
				unescapeTemplateVariables(entityLinks.linkToItemResource(TaskAppStatusResource.class, "{name}")
                    .withRel("tasks/validation"))
			);
            root.add(linkTo(
					methodOn(TasksInfoController.class).getInfo(null, null)
			).withRel("tasks/info/executions"));
            root.add(linkTo(
					methodOn(TaskLogsController.class).getLog(null, null)
			).withRel("tasks/logs"));
