...
public class RedisUriRegistry implements UriRegistry {
	...
	/**
	 * Prefix for keys used for storing URIs.
	 */
	public static final String KEY_PREFIX = "spring.cloud.resource.uri";
	...
	private BoundHashOperations<String, String, String> hashOps() {
		return this.redisOperations.boundHashOps(KEY_PREFIX);
	}
