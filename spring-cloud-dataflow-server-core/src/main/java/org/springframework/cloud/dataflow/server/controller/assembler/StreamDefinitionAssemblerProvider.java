...
public interface StreamDefinitionAssemblerProvider<R extends StreamDefinitionResource> {
	 ...
	 * @param streamDefinitions the list of stream definitions to check their deployment status
	 * @return the stream definition resource assembler
	 */
	RepresentationModelAssembler<StreamDefinition, R> getStreamDefinitionAssembler(List<StreamDefinition> streamDefinitions);
