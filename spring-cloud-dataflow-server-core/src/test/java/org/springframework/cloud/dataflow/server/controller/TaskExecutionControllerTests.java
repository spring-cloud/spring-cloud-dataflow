...
public class TaskExecutionControllerTests {
	...
	@Autowired
    private TaskDefinitionRetriever taskDefinitionRetriever;
	...
	public void testTaskExecutionControllerConstructorMissingExplorer() {
		new TaskExecutionController(null, taskExecutionService, taskDefinitionRepository, taskDefinitionRetriever,
				taskDeleteService);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testTaskExecutionControllerConstructorMissingTaskService() {
		new TaskExecutionController(taskExplorer, null, taskDefinitionRepository, taskDefinitionRetriever,
				taskDeleteService);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testTaskExecutionControllerConstructorMissingTaskDefinitionRepository() {
		new TaskExecutionController(taskExplorer, taskExecutionService, null, taskDefinitionRetriever,
				taskDeleteService);
	}
