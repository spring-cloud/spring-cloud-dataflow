...
public class TaskExecutionControllerTests {
	...
	public void setupMockMVC() {
		...
		if (!initialized) {
			...
			dao.createTaskExecution(TASK_NAME_ORIG, new Date(), this.SAMPLE_ARGUMENT_LIST, "foobar");
			dao.createTaskExecution(TASK_NAME_ORIG, new Date(), this.SAMPLE_ARGUMENT_LIST, null);
			dao.createTaskExecution(TASK_NAME_FOO, new Date(), this.SAMPLE_ARGUMENT_LIST, null);
			TaskExecution taskExecution = dao.createTaskExecution(TASK_NAME_FOOBAR, new Date(), this.SAMPLE_ARGUMENT_LIST,
					null);
	...
	public void testGetAllExecutions() throws Exception {
		verifyTaskArgs(this.SAMPLE_CLEANSED_ARGUMENT_LIST, "$.content[0].",
	...
	public void testGetExecutionsByName() throws Exception {
		verifyTaskArgs(this.SAMPLE_CLEANSED_ARGUMENT_LIST, "$.content[0].", mockMvc
