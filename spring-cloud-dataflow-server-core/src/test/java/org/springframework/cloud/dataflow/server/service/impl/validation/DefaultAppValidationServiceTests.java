...
public class DefaultAppValidationServiceTests {
	...
	private void initializeSuccessfulRegistry(AppRegistry appRegistry) {
		...
		createAppValidationService();
	}

	private void createAppValidationService() {

		// this.appValidationService = new DefaultAppValidationService(this.appRegistry,
		// this.dockerValidatorProperties,
		// this.taskDefinitionRepository, this.streamDefinitionRepository,
		// this.taskConfigurationProperties.getComposedTaskRunnerName());
	}
	...
	private void initializeInvalidDockerRegistry(AppRegistry appRegistry) {
		when(appRegistry.find(anyString(), any(ApplicationType.class))).thenReturn(
