...
package org.springframework.cloud.dataflow.configuration.metadata.container.authorization.support.S3SignedRedirectRequestServer;
...
public class S3SignedRedirectRequestController {
    ...
    public ResponseEntity<Map<String, String>> getBlobRedirect(@RequestHeader("Authorization") String token) {
        ...
        redirectHeaders.add(HttpHeaders.LOCATION, "/test/docker/registry/v2/blobs/test/data?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=test&X-Amz-Date=test&X-Amz-Expires=1200&X-Amz-SignedHeaders=host&X-Amz-Signature=test");
    ...
    private ResponseEntity<Resource> buildFromString(String body) {
        ...
        return ResponseEntity.ok()
                ...
                .contentType(MediaType.valueOf(ContainerImageMetadataProperties.DOCKER_IMAGE_MANIFEST_MEDIA_TYPE))
                .body(resource);
    }
}
