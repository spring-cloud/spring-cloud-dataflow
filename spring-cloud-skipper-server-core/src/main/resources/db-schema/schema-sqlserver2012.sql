    ...
    drop table jpa_repository_action;

    drop table jpa_repository_guard;

    drop table jpa_repository_state;

    drop table jpa_repository_state_deferred_events;

    drop table jpa_repository_state_entry_actions;

    drop table jpa_repository_state_exit_actions;

    drop table jpa_repository_state_state_actions;

    drop table jpa_repository_state_machine;

    drop table jpa_repository_transition;

    drop table jpa_repository_transition_actions;

    drop table skipper_app_deployer_data;

    drop table skipper_info;

    drop table skipper_package_metadata;

    drop table skipper_release;

    drop table skipper_repository;

    drop table skipper_status;
